...
// Complete National Pokédex database spanning Generation 1 to 9 (1 to 1028)
// Raw master list: [dex, name, type1, type2?, isSpecial?]
const RAW_POKEDEX_ENTRIES: [number, string, PokemonType, PokemonType?, number?][] = [
  // Gen 1 (1 - 151)
  ...
  [150, 'Mewtwo', 'Psychic', undefined, 1],
  [151, 'Mew', 'Psychic', undefined, 2],
  ...
  [241, 'Miltank', 'Normal'],
  [242, 'Blissey', 'Normal'],
  [243, 'Raikou', 'Electric', undefined, 1],
  [244, 'Entei', 'Fire', undefined, 1],
  [245, 'Suicune', 'Water', undefined, 1],
  [246, 'Larvitar', 'Rock', 'Ground'],
  [247, 'Pupitar', 'Rock', 'Ground'],
  [248, 'Tyranitar', 'Rock', 'Dark'],
  [249, 'Lugia', 'Psychic', 'Flying', 1],
  [250, 'Ho-Oh', 'Fire', 'Flying', 1],
  ...
  [377, 'Regirock', 'Rock', undefined, 1],
  [378, 'Regice', 'Ice', undefined, 1],
  [379, 'Registeel', 'Steel', undefined, 1],
  [380, 'Latias', 'Dragon', 'Psychic', 1],
  [381, 'Latios', 'Dragon', 'Psychic', 1],
  [382, 'Kyogre', 'Water', undefined, 1],
  [383, 'Groudon', 'Ground', undefined, 1],
  [384, 'Rayquaza', 'Dragon', 'Flying', 1],
  [385, 'Jirachi', 'Steel', 'Psychic', 2],
  [386, 'Deoxys', 'Psychic', undefined, 2],
  ...
  [480, 'Uxie', 'Psychic', undefined, 1],
  [481, 'Mesprit', 'Psychic', undefined, 1],
  [482, 'Azelf', 'Psychic', undefined, 1],
  [483, 'Dialga', 'Steel', 'Dragon', 1],
  [484, 'Palkia', 'Water', 'Dragon', 1],
  [485, 'Heatran', 'Fire', 'Steel', 1],
  [486, 'Regigigas', 'Normal', undefined, 1],
  [487, 'Giratina', 'Ghost', 'Dragon', 1],
  [488, 'Cresselia', 'Psychic', undefined, 1],
  [489, 'Phione', 'Water', undefined, 2],
  [490, 'Manaphy', 'Water', undefined, 2],
  [491, 'Darkrai', 'Dark', undefined, 2],
  [492, 'Shaymin', 'Grass', undefined, 2],
  [493, 'Arceus', 'Normal', undefined, 2],

  // Gen 5 (494 - 649)
  [494, 'Victini', 'Psychic', 'Fire', 2],
  [495, 'Snivy', 'Grass'],
  [496, 'Servine', 'Grass'],
  [497, 'Serperior', 'Grass'],
  [498, 'Tepig', 'Fire'],
  ...
  [638, 'Cobalion', 'Steel', 'Fighting', 1],
  [639, 'Terrakion', 'Rock', 'Fighting', 1],
  [640, 'Virizion', 'Grass', 'Fighting', 1],
  [641, 'Tornadus', 'Flying', undefined, 1],
  [642, 'Thundurus', 'Electric', 'Flying', 1],
  [643, 'Reshiram', 'Dragon', 'Fire', 1],
  [644, 'Zekrom', 'Dragon', 'Electric', 1],
  [645, 'Landorus', 'Ground', 'Flying', 1],
  [646, 'Kyurem', 'Dragon', 'Ice', 1],
  [647, 'Keldeo', 'Water', 'Fighting', 2],
  [648, 'Meloetta', 'Normal', 'Psychic', 2],
  [649, 'Genesect', 'Bug', 'Steel', 2],
  ...
  [716, 'Xerneas', 'Fairy', undefined, 1],
  [717, 'Yveltal', 'Dark', 'Flying', 1],
  [718, 'Zygarde', 'Dragon', 'Ground', 1],
  [719, 'Diancie', 'Rock', 'Fairy', 2],
  [720, 'Hoopa', 'Psychic', 'Ghost', 2],
  [721, 'Volcanion', 'Fire', 'Water', 2],
  ...
  [771, 'Pyukumuku', 'Water'],
  [772, 'Type: Null', 'Normal', undefined, 1],
  [773, 'Silvally', 'Normal', undefined, 1],
  ...
  [785, 'Tapu Koko', 'Electric', 'Fairy', 1],
  [786, 'Tapu Lele', 'Psychic', 'Fairy', 1],
  [787, 'Tapu Bulu', 'Grass', 'Fairy', 1],
  [788, 'Tapu Fini', 'Water', 'Fairy', 1],
  [789, 'Cosmog', 'Psychic', undefined, 1],
  [790, 'Cosmoem', 'Psychic', undefined, 1],
  [791, 'Solgaleo', 'Psychic', 'Steel', 1],
  [792, 'Lunala', 'Psychic', 'Ghost', 1],
  [793, 'Nihilego', 'Rock', 'Poison', 3],
  [794, 'Buzzwole', 'Bug', 'Fighting', 3],
  [795, 'Pheromosa', 'Bug', 'Fighting', 3],
  [796, 'Xurkitree', 'Electric', undefined, 3],
  [797, 'Celesteela', 'Steel', 'Flying', 3],
  [798, 'Kartana', 'Grass', 'Steel', 3],
  [799, 'Guzzlord', 'Dark', 'Dragon', 3],
  [800, 'Necrozma', 'Psychic', undefined, 1],
  [801, 'Magearna', 'Steel', 'Fairy', 2],
  [802, 'Marshadow', 'Fighting', 'Ghost', 2],
  [803, 'Poipole', 'Poison', undefined, 3],
  [804, 'Naganadel', 'Poison', 'Dragon', 3],
  [805, 'Stakataka', 'Rock', 'Steel', 3],
  [806, 'Blacephalon', 'Fire', 'Ghost', 3],
  [807, 'Zeraora', 'Electric', undefined, 2],
  [808, 'Meltan', 'Steel', undefined, 2],
  [809, 'Melmetal', 'Steel', undefined, 2],
  ...
  [888, 'Zacian', 'Fairy', 'Steel', 1],
  [889, 'Zamazenta', 'Fighting', 'Steel', 1],
  [890, 'Eternatus', 'Poison', 'Dragon', 1],
  [891, 'Kubfu', 'Fighting', undefined, 1],
  [892, 'Urshifu', 'Fighting', 'Dark', 1],
  [893, 'Zarude', 'Dark', 'Grass', 2],
  [894, 'Regieleki', 'Electric', undefined, 1],
  [895, 'Regidrago', 'Dragon', undefined, 1],
  [896, 'Glastrier', 'Ice', undefined, 1],
  [897, 'Spectrier', 'Ghost', undefined, 1],
  [898, 'Calyrex', 'Psychic', 'Grass', 1],
  ...
  [984, 'Great Tusk', 'Ground', 'Fighting', 1],
  [985, 'Scream Tail', 'Fairy', 'Psychic', 1],
  [986, 'Brute Bonnet', 'Grass', 'Dark', 1],
  [987, 'Flutter Mane', 'Ghost', 'Fairy', 1],
  [988, 'Slither Wing', 'Bug', 'Fighting', 1],
  [989, 'Sandy Shocks', 'Electric', 'Ground', 1],
  [990, 'Iron Treads', 'Ground', 'Steel', 1],
  [991, 'Iron Bundle', 'Ice', 'Water', 1],
  [992, 'Iron Hands', 'Fighting', 'Electric', 1],
  [993, 'Iron Jugulis', 'Dark', 'Flying', 1],
  [994, 'Iron Moth', 'Fire', 'Poison', 1],
  [995, 'Iron Thorns', 'Rock', 'Electric', 1],
  [996, 'Frigibax', 'Dragon', 'Ice'],
  [997, 'Arctibax', 'Dragon', 'Ice'],
  [998, 'Baxcalibur', 'Dragon', 'Ice'],
  [999, 'Gimmighoul', 'Ghost'],
  [1000, 'Gholdengo', 'Steel', 'Ghost'],
  [1001, 'Wo-Chien', 'Dark', 'Grass', 1],
  [1002, 'Chien-Pao', 'Dark', 'Ice', 1],
  [1003, 'Ting-Lu', 'Dark', 'Ground', 1],
  [1004, 'Chi-Yu', 'Dark', 'Fire', 1],
  [1005, 'Roaring Moon', 'Dragon', 'Dark', 1],
  [1006, 'Iron Valiant', 'Fairy', 'Fighting', 1],
  [1007, 'Koraidon', 'Fighting', 'Dragon', 1],
  [1008, 'Miraidon', 'Electric', 'Dragon', 1],
  [1009, 'Walking Wake', 'Water', 'Dragon', 1],
  [1010, 'Iron Leaves', 'Grass', 'Psychic', 1],
  [1011, 'Dipplin', 'Grass', 'Dragon'],
  [1012, 'Poltchageist', 'Grass', 'Ghost'],
  [1013, 'Sinistcha', 'Grass', 'Ghost'],
  [1014, 'Okidogi', 'Poison', 'Fighting', 1],
  [1015, 'Munkidori', 'Poison', 'Psychic', 1],
  [1016, 'Fezandipiti', 'Poison', 'Fairy', 1],
  [1017, 'Ogerpon', 'Grass', undefined, 1],
  [1018, 'Archaludon', 'Steel', 'Dragon'],
  [1019, 'Hydrapple', 'Grass', 'Dragon'],
  [1020, 'Gouging Fire', 'Fire', 'Dragon', 1],
  [1021, 'Raging Bolt', 'Electric', 'Dragon', 1],
  [1022, 'Iron Boulder', 'Rock', 'Psychic', 1],
  [1023, 'Iron Crown', 'Steel', 'Psychic', 1],
  [1024, 'Terapagos', 'Normal', undefined, 1],
  [1025, 'Pecharunt', 'Poison', 'Ghost', 2],
  [1026, 'Mewtwo (Armored)', 'Psychic', undefined, 1],
  [1027, 'Kyurem (Black)', 'Dragon', 'Ice', 1],
  [1028, 'Kyurem (White)', 'Dragon', 'Fire', 1],
];

export const POPULAR_POKEMON_LIST: PokemonCatalogItem[] = RAW_POKEDEX_ENTRIES.map(
  ([dex, name, t1, t2, special]) => {
    const types: PokemonType[] = t2 ? [t1, t2] : [t1];
    return {
      dex,
      name,
      types,
      sprite: `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${dex}.png`,
      isLegendary: special === 1,
      isMythical: special === 2,
      isUltraBeast: special === 3,
    };
  }
);
...
export function findPokemonByNameOrDex(query: string): PokemonCatalogItem | undefined {
  ...
  if (!isNaN(num) && num > 0 && num <= 1028) {
    const found = POPULAR_POKEMON_LIST.find((p) => p.dex === num);
    if (found) return found;
    return {
      dex: num,
      name: `Pokémon #${num}`,
      types: ['Normal'],
      sprite: `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${num}.png`,
    };
  }

  return (
    POPULAR_POKEMON_LIST.find((p) => p.name.toLowerCase() === clean) ||
    POPULAR_POKEMON_LIST.find((p) => p.name.toLowerCase().startsWith(clean)) ||
    POPULAR_POKEMON_LIST.find((p) => p.name.toLowerCase().includes(clean))
  );
}

export function searchPokemonCatalog(query: string, limit = 12): PokemonCatalogItem[] {
  const clean = query.trim().toLowerCase();
  ...
  if (!isNaN(num)) {
    return POPULAR_POKEMON_LIST.filter(
      (p) => p.dex.toString().startsWith(clean) || p.dex.toString().includes(clean)
    ).slice(0, limit);
  }
